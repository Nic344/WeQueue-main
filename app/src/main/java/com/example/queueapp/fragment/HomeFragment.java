...
public class HomeFragment extends Fragment {
        ...
        apiService.getQueueStatus().enqueue(new Callback<ApiResponse<QueueStatusResponse>>() {
            ...
            public void onResponse(Call<ApiResponse<QueueStatusResponse>> call,
                ...
                if (response.isSuccessful() && body != null && body.isSuccess() && body.getData() != null) {
                    ...
                    showRetry(response, R.string.queue_status, HomeFragment.this::loadAllData);
                }
                finishLoad();
            }
            ...
            public void onFailure(Call<ApiResponse<QueueStatusResponse>> call, Throwable t) {
                ...
                showRetry(t, HomeFragment.this::loadAllData);
                finishLoad();
            }
        });
    }

    private void loadMyQueue() {
        ...
        apiService.getFavorites().enqueue(new Callback<ApiResponse<FavoriteListResponse>>() {
            ...
            public void onResponse(Call<ApiResponse<FavoriteListResponse>> call,
                ...
                if (response.isSuccessful() && body != null && body.isSuccess() && body.getData() != null) {
                    ...
                    showRetry(response, R.string.favorites, HomeFragment.this::loadAllData);
                }
                finishLoad();
            }
        ...
        apiService.getPopularFoods().enqueue(new Callback<ApiResponse<FoodListResponse>>() {
            ...
            public void onResponse(Call<ApiResponse<FoodListResponse>> call,
                ...
                if (response.isSuccessful() && body != null && body.isSuccess() && body.getData() != null) {
                    ...
                    showRetry(response, R.string.popular_foods, HomeFragment.this::loadAllData);
                }
                finishLoad();
            }
        ...
        call.enqueue(new Callback<ApiResponse<Object>>() {
            ...
            public void onResponse(Call<ApiResponse<Object>> call, Response<ApiResponse<Object>> response) {
                ...
                if (response.isSuccessful() && body != null && body.isSuccess()) {
                    ...
                    showRetry(response, R.string.favorites, () ->
                            toggleFavorite(anchor, food, currentlyFavorite));
                }
            }
            ...
            public void onFailure(Call<ApiResponse<Object>> call, Throwable t) {
                ...
                showRetry(t, () -> toggleFavorite(anchor, food, currentlyFavorite));
            }
        });
    }
    ...
    private void showRandomFoodDialog(View anchor) {
        if (popularFoods.isEmpty()) {
            Snackbar.make(anchor, R.string.no_results, Snackbar.LENGTH_SHORT)
                    .setAction(R.string.retry, v -> loadPopularFoods())
                    .show();
            return;
        }
    ...
    private void showRetry(Response<?> response, int labelRes, Runnable retry) {
        String fallback = getString(R.string.load_failed, getString(labelRes));
        Snackbar.make(requireView(), ApiErrorHelper.getMessage(response, fallback), Snackbar.LENGTH_LONG)
